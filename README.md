...
I'm a **Full-Stack Web Developer** specializing in building scalable e-commerce applications, responsive interfaces, and modular REST APIs with **React, Next.js, TypeScript, Node.js, Express.js, and MongoDB**.

- 🚀 Building production-style storefronts, admin dashboards, and e-commerce APIs
- ⚛️ Creating responsive interfaces with **React, Next.js, Vite, and Tailwind CSS**
- ⚙️ Developing secure backend services with **Node.js, Express.js, MongoDB, JWT, and Redis**
- 🔌 Integrating payments, image uploads, email workflows, and external APIs
- 🤝 Experienced with collaborative Git and GitHub workflows
